...
Stick .description = "The Stick to to hit Sakura ";
const Door = new Item("Door");
Door.description = " the door is open to adeep well ";


const Sakura = new Enemy("Sakura");
Sakura.conversation = "I want to live";
Sakura.description = " is standing in the middle of the hall , she is an introverted and eccentric ";
Sakura.pronoun = "she";
Sakura.weakness = Stick ;



const Nier = new Enemy("Nier");
Nier.conversation = "Don't touch me hahaha .....";
Nier.description = "is standing in front of you , he is black and huge with bright red eyes , he carries astick on the right hand";
Nier.pronoun = "he";
Nier.gift = Stick;



MasterRoom.character  =Nier;
Hall.character =Sakura;
...
function commandHandler(command, character, room ) {
    ...
    switch (command) {
      ...
      case "open":
       ...
       case "speak":
           if (character) {
               if (room.character === Sakura) {
               msg = character .converse()  ;
                alert(msg);
                break;
            } else if (room.character === Nier){
              msg = character.converse() ;
                alert(msg);
                break;}
               } else{
